...
it is currently set to glob png files in the directory it is run from, so just pop those bad bois in there and you're ready to rock. if you have jpgs and want to use those find the line of code that has a '*.png' (line #74 as of writing this) and change the .png to .jpg and thats it!
